                    ...
                    <React.Fragment key={row.id}>
                      ...
                      >
                        ...
                        <TableCell>
                            ...
                            <Chip 
                              label={row.role === 'ADMIN' ? 'Boss / Manager' : (row.role === 'SUPER_ADMIN' ? 'System Root' : 'Staff / Employee')} 
                              size='small' 
                        ...
                        <TableCell>
                          ...
                          <Typography variant='caption' className='text-slate-400'>Level: {row.role}</Typography>
                        </TableCell>
            ...
            <DialogContent className='p-0'>
                ...
                <Box className='pt-16 px-10 pb-10'>
                    <Box className='flex justify-between items-start mbe-6'>
                        ...
                        <Chip label={selectedUser.status} color={selectedUser.status === 'ACTIVE' ? 'success' : 'error'} className='font-black' />
                    </Box>
